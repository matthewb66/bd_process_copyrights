...
class Config:
    ...
    def get_cli_args(self):
        ...
        parser.add_argument(
            "--all_copyrights",
            help="Process all components for alternate origins and local scan copyrights, not just those with zero existing copyrights",
            action='store_true'
        )
        parser.add_argument(
            "--report",
        ...
        self.all_copyrights = args.all_copyrights
